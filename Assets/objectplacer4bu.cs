...
public class objectplacer4bu : MonoBehaviour
{
    [Header("배치 설정")]
    ...
    private void Awake()
    {
        ...
        previewMaterial.color = new Color(1f, 1f, 0f, 0.4f); // 반투명 노랑
    }
    ...
    private void CreatePreview(GameObject original)
    {
        ...
        foreach (var r in rends)
        {
            ...
            {
                Material m = new Material(previewBaseMaterial); // 퍼블릭 머티리얼 복사
                Color c = m.color;
                mats[i] = m;
            }
            r.materials = mats;
    ...
    private void ApplyHighlight(GameObject obj)
    {
        ...
        for (int i = 0; i < renderers.Length; i++)
        {
            ...
            {
                // previewBaseMaterial 복사 후 색상만 highlightColor로 변경
